...
This week has been the starting week of the course. I started by creating a Github account and creating my own course page by forking the course page from the instructor. I also downloaded the GitHub desktop and finally managed to clone my web repository to the desktop version. After that, I realized that it is actually quite handy, because you can use RStudio to modify the documnets and then you just need to go the GitHub desktop and first commit the changed and then push them to the web version. You can have a web diary of our work and notes and you can access it with every computer.
